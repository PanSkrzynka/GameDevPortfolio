...
#include "CVehicleAreaOffroadCar.h"
#include "CVehicleAreaOffroadWheelFront.h"
#include "CVehicleAreaOffroadWheelRear.h"
...
ACVehicleAreaOffroadCar::ACVehicleAreaOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCVehicleAreaOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCVehicleAreaOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCVehicleAreaOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCVehicleAreaOffroadWheelRear::StaticClass();
