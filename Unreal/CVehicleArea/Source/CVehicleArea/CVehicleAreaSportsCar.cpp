...
#include "CVehicleAreaSportsCar.h"
#include "CVehicleAreaSportsWheelFront.h"
#include "CVehicleAreaSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACVehicleAreaSportsCar::ACVehicleAreaSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCVehicleAreaSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCVehicleAreaSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCVehicleAreaSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCVehicleAreaSportsWheelRear::StaticClass();
